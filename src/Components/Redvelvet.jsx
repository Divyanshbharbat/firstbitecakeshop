...
const Redvelvet = () => {
    ...
    let y=async()=>
      {
        ...
        try{
          ...
          console.log(token)// Assuming token is stored in localStorage
              const response =  await axios.get(`${import.meta.env.VITE_URL}/getdata4`, {
                headers: {
  ...
  return (
    ...
    <>
    <h1  className=' my-5  text-center mx-5 ' style={{color:"black",fontSize:"9vh" ,fontWeight:"bolder"}}>Red Velvet Cake</h1>
